...
<div class="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden mx-auto my-8">
    ...
    <div class="p-6">
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <button onclick="openModal()" class="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200 inline-block text-center">
                Edit Profil
            </button>
        </div>
    </div>
